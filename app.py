...
if st.button("Consultar Protocolos"):
    if not api_key:
        ...
        with st.spinner("Accediendo a los protocolos del hospital..."):
            try:
                contexto = extraer_texto()
                # LA URL DEFINITIVA (Cambiamos gemini-pro por gemini-1.0-pro)
                ...
                if response.status_code == 200:
                    ...
                    st.error(f"Error técnico de Google: {data['error']['message']}")
